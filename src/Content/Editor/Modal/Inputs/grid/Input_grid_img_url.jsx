...
function Input_grid_img_url({ articleData, id, modifyArticle, path, item }) {
  ...
  return (
    <span>
      <label htmlFor={`url_input_grid_img${item}`}>URL: </label>
      <input
        type="text"
        id={`url_input_grid_img${item}`}
        name={`url_input_grid_img${item}`}
        className="grid_img_url"
        placeholder="..."
...
export default Input_grid_img_url;

Input_grid_img_url.propTypes = {
  id: PropTypes.number,
